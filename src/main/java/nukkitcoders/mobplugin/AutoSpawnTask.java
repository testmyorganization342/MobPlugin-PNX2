...
public class AutoSpawnTask implements Runnable {
    ...
    private void prepareMaxSpawns() {
        ...
        maxSpawns.put(10, this.pluginConfig.getInt("autospawn.chicken"));
        maxSpawns.put(112, this.pluginConfig.getInt("autospawn.cod"));
        maxSpawns.put(11, this.pluginConfig.getInt("autospawn.cow"));
        maxSpawns.put(33, this.pluginConfig.getInt("autospawn.creeper"));
        ...
        maxSpawns.put(23, this.pluginConfig.getInt("autospawn.horse"));
        ...
        maxSpawns.put(16, this.pluginConfig.getInt("autospawn.mooshroom"));
        ...
        maxSpawns.put(12, this.pluginConfig.getInt("autospawn.pig"));
        ...
        maxSpawns.put(109, this.pluginConfig.getInt("autospawn.salmon"));
        maxSpawns.put(13, this.pluginConfig.getInt("autospawn.sheep"));
        ...
        maxSpawns.put(111, this.pluginConfig.getInt("autospawn.tropicalfish"));
        ...
        maxSpawns.put(14, this.pluginConfig.getInt("autospawn.wolf"));
        maxSpawns.put(32, this.pluginConfig.getInt("autospawn.zombie"));
